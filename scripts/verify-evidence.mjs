 ...
 *   1. the fixture safety checks in supabase/tests/safety-checks.sql pass;
 *   2. re-recording from a clean database twice reproduces the committed
 *      transcript exactly, apart from the wall-clock recording timestamp;
 *   3. the committed transcript's digest still matches the migrations and
 *      test set on disk, so a transcript can never silently go stale.
 */
...
const COMMITTED = "lib/evidence/recorded/s2-authorization-transcript.json";
